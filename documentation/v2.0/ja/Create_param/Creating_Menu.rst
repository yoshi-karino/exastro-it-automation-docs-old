.. image:: ./Creating_Menu/image1.png
   :width: 3.35069in
   :height: 0.79236in
...
..
   ...
   .. image:: ./Creating_Menu/image2.png
      :width: 6.67391in
      :height: 3.20028in
   ...
   .. image:: ./Creating_Menu/image3.png
      :width: 6.69236in
      :height: 2.95139in
   ...
   .. image:: ./Creating_Menu/image4.png
      :width: 6.23387in
      :height: 2.7069in
   ...
   .. image:: ./Creating_Menu/image5.png
      :width: 6.30055in
      :height: 2.3202in
...
.. image:: ./Creating_Menu/image6.png
   :width: 6.69236in
   :height: 1.84583in

図　4-1　「作成対象」欄

.. image:: ./Creating_Menu/image7.png
   :width: 5.21378in
   :height: 1.64681in

図　4-2　「作成対象」欄で「パラメータシート」を選択し作成されたメニュー（パラメータシート）

.. image:: ./Creating_Menu/image8.png
   :width: 5.09378in
   :height: 1.64681in
...
.. image:: ./Creating_Menu/image10.png
   :width: 5.02755in
   :height: 0.94812in
...
.. image:: ./Creating_Menu/image11.png
   :width: 6.69236in
   :height: 4.15903in
...
-  | 「項目」ボタン
   | 「項目」ボタンを押下すると項目が出力され設定できるようになります。プルダウンメニューから入力方式を選択し、必須項目を入力するとメニュー（パラメータシート/データシート）に項目として追加することが可能です。
...
.. image:: ./Creating_Menu/image13.png
   :width: 6.08396in
   :height: 1.41856in
...
.. image:: ./Creating_Menu/image14.png
   :width: 6.29921in
   :height: 3.12575in
...
.. image:: ./Creating_Menu/image15.png
   :width: 5.4125in
   :height: 2.39482in
...
.. image:: ./Creating_Menu/image16.png
   :width: 5.91544in
   :height: 5.18333in
...
.. image:: ./Creating_Menu/image17.png
   :width: 6.26679in
   :height: 3.65152in
...
.. image:: ./Creating_Menu/image18.png
   :width: 4.23577in
   :height: 1.98283in
...
.. image:: ./Creating_Menu/image19.png
   :width: 3.15833in
   :height: 1.09722in
...
.. image:: ./Creating_Menu/image20.png
   :width: 4.94653in
   :height: 0.59481in
...
.. image:: ./Creating_Menu/image22.png
   :width: 3.07895in
   :height: 0.69767in
...
.. image:: ./Creating_Menu/image23.png
   :width: 5.20712in
   :height: 2.76691in
...
.. image:: ./Creating_Menu/image24.png
   :width: 4.85375in
   :height: 2.58022in
...
.. image:: ./Creating_Menu/image25.png
   :width: 6.69236in
   :height: 2.95903in
...
.. image:: ./Creating_Menu/image26.png
   :width: 5.90718in
   :height: 2.82691in
...
.. image:: ./Creating_Menu/image27.png
   :width: 6.68725in
   :height: 2.43354in
...
.. image:: ./Creating_Menu/image28.png
   :width: 5.54048in
   :height: 2.28686in
...
.. image:: ./Creating_Menu/image29.png
   :width: 5.29401in
   :height: 2.7088in
...
**A)　入力用メニューグループ**
   ...
   .. image:: ./Creating_Menu/image30.png
      :width: 5.90718in
      :height: 1.76682in
...
.. image:: ./Creating_Menu/image31.png
   :width: 4.76041in
   :height: 2.10685in
...
.. image:: ./Creating_Menu/image32.png
   :width: 5.16045in
   :height: 2.27353in
...
.. image:: ./Creating_Menu/image33.png
   :width: 6.28721in
   :height: 3.00693in
...
図　5.7-8　代入値自動登録用メニューグループ配下に作成されたパラメータシート
   ...
   **C) 参照用メニューグループ**
   ...
   .. image:: ./Creating_Menu/image34.png
      :width: 6.25388in
      :height: 2.55355in
...
.. image:: ./Creating_Menu/image35.png
   :width: 5.16042in
   :height: 2.37986in
...
.. image:: ./Creating_Menu/image36.png
   :width: 5.06711in
   :height: 1.9135in
...
図　5.7-12　入力用メニューグループ配下に作成されたパラメータシート
   ...
   **B)　代入値自動登録用メニューグループ**
   ...
   .. image:: ./Creating_Menu/image37.png
      :width: 5.36046in
      :height: 2.50022in
...
図　5.7-13　代入値自動登録用メニューグループ配下に作成されたパラメータシート
   ...
   **C)　参照用メニューグループ**
   ...
   .. image:: ./Creating_Menu/image38.png
      :width: 5.85384in
      :height: 2.91359in
...
.. image:: ./Creating_Menu/image39.png
   :width: 5.84051in
   :height: 2.70023in
...
**図　5.7-16　「入力用」「代入値自動登録用」「参照用」メニューグループ**
   ...
   **A) 入力用メニューグループ**
   ...
   .. image:: ./Creating_Menu/image40.png
      :width: 5.3738in
      :height: 2.39354in
...
図　5.7-17　入力用メニューグループ配下に作成されたパラメータシート
   ...
   .. image:: ./Creating_Menu/image41.png
      :width: 2.27473in
      :height: 2.24636in
...
.. image:: ./Creating_Menu/image42.png
   :width: 5.84028in
   :height: 2.71319in
...
図　5.7-19　代入値自動登録用メニューグループ配下に作成されたパラメータシート
   ...
   **C)　参照用メニューグループ**
   ...
   .. image:: ./Creating_Menu/image43.png
      :width: 6.22721in
      :height: 2.66023in
...
.. image:: ./Creating_Menu/image44.png
   :width: 5.36046in
   :height: 2.47355in
...
**図　5.7-23　「入力用」「代入値自動登録用」「参照用」メニューグループ**
   ...
   **A) 入力用メニューグループ**
   ...
   .. image:: ./Creating_Menu/image46.png
      :width: 5.74716in
      :height: 2.55355in
...
図　5.7-24　入力用メニューグループ配下に作成されたパラメータシート
   ...
   .. image:: ./Creating_Menu/image47.png
      :width: 5.84051in
      :height: 2.58022in
...
図　5.7-25　入力用メニューグループ配下に作成されたパラメータシート
   ...
   .. image:: ./Creating_Menu/image48.png
      :width: 5.60049in
      :height: 2.55355in
...
図　5.7-26　「メニュー定義・作成」メニュー
   ...
   .. image:: ./Creating_Menu/image49.png
      :width: 5.48681in
      :height: 1.76667in
...
図　5.7-27　入力用メニューグループ配下に作成されたパラメータシート
   ...
   **B)　代入値自動登録用メニューグループ**
   ...
   .. image:: ./Creating_Menu/image50.png
      :width: 6.69236in
      :height: 1.70972in
...
図　5.7-28　代入値自動登録用メニューグループ配下に作成されたパラメータシート
   ...
   **C)　参照用メニューグループ**
   ...
   .. image:: ./Creating_Menu/image51.png
      :width: 6.20054in
      :height: 2.88692in
...
.. image:: ./Creating_Menu/image52.png
   :width: 6.5739in
   :height: 2.92692in
...
.. image:: ./Creating_Menu/image53.png
   :width: 5.78717in
   :height: 2.74024in
...
.. image:: ./Creating_Menu/image54.png
   :width: 6.25388in
   :height: 2.76691in
...
.. image:: ./Creating_Menu/image55.png
   :width: 6.65391in
   :height: 2.94025in
...
例）hosts ファイルへ記載するパラメータを管理
   ...
   .. image:: ./Creating_Menu/image45.png
      :width: 4.01701in
      :height: 1.5168in
   ...
   .. image:: ./Creating_Menu/image56.png
      :width: 5.7762in
      :height: 0.46054in
   ...
   .. image:: ./Creating_Menu/image57.png
      :width: 6.29921in
      :height: 0.96544in
...
.. image:: ./Creating_Menu/image59.png
   :width: 5.20045in
   :height: 3.02026in
...
.. image:: ./Creating_Menu/image60.png
   :width: 6.16154in
   :height: 3.98153in
...
.. image:: ./Creating_Menu/image61.png
   :width: 6.24054in
   :height: 2.58022in
...
.. image:: ./Creating_Menu/image63.png
   :width: 5.78717in
   :height: 2.42021in
...
.. image:: ./Creating_Menu/image64.jpg
   :width: 6.69236in
   :height: 0.45694in
...
.. image:: ./Creating_Menu/image65.png
   :width: 6.69236in
   :height: 3.09931in
...
.. image:: ./Creating_Menu/image66.png
   :width: 6.69236in
   :height: 2.84583in
...
.. image:: ./Creating_Menu/image67.png
   :width: 6.69236in
   :height: 3.21944in
...
.. image:: ./Creating_Menu/image68.png
   :width: 6.69236in
   :height: 3.36597in
...
.. image:: ./Creating_Menu/image69.png
   :width: 6.69236in
   :height: 3.3125in
...
.. image:: ./Creating_Menu/image70.png
   :width: 5.40859in
   :height: 4.05379in
...
.. image:: ./Creating_Menu/image71.png
   :width: 5.75315in
   :height: 2.85225in
...
.. image:: ./Creating_Menu/image72.png
   :width: 6.68058in
   :height: 3.52697in
...
.. image:: ./Creating_Menu/image73.png
   :width: 4.3216in
   :height: 2.45475in

.. image:: ./Creating_Menu/image74.png
   :width: 5.71451in
   :height: 1.78011in

.. image:: ./Creating_Menu/image75.png
   :width: 5.64162in
   :height: 2.81817in
...
.. image:: ./Creating_Menu/image76.png
   :width: 6.69236in
   :height: 1.56597in

.. image:: ./Creating_Menu/image77.png
   :width: 4.31061in
   :height: 2.3586in

.. image:: ./Creating_Menu/image78.png
   :width: 6.69236in
   :height: 1.74086in

.. image:: ./Creating_Menu/image79.png
   :width: 6.69236in
   :height: 1.42778in
...
.. image:: ./Creating_Menu/image80.png
   :width: 4.11364in
   :height: 2.76946in

.. image:: ./Creating_Menu/image81.png
   :width: 6.20604in
   :height: 1.76515in

.. image:: ./Creating_Menu/image82.png
   :width: 4.29587in
   :height: 2.94697in

.. image:: ./Creating_Menu/image83.png
   :width: 6.50099in
   :height: 2.68125in

.. image:: ./Creating_Menu/image84.png
   :width: 5.64286in
   :height: 2.87111in
...
.. image:: ./Creating_Menu/image85.png
   :width: 6.69236in
   :height: 1.91736in

.. image:: ./Creating_Menu/image86.png
   :width: 6.69236in
   :height: 3.38472in
...
※「メニュー作成」メニューグループ＞「メニュー定義・作成」メニューで作成する場合(画面上で作成する場合)は以下になります。
   ...
   .. image:: ./Creating_Menu/image87.png
...
..
   ...
   .. image:: ./Creating_Menu/image88.png
...
..
   ...
   .. image:: ./Creating_Menu/image89.png
...
..
   ...
   .. image:: ./Creating_Menu/image90.png
...
..
   ...
   .. image:: ./Creating_Menu/image91.png
...
..
   ...
   .. image:: ./Creating_Menu/image92.png
      :alt: グラフィカル ユーザー インターフェイス, アプリケーション,
      テーブル 自動的に生成された説明
      :width: 6.39028in
      :height: 2.83408in
...
..
   ...
   .. image:: ./Creating_Menu/image93.png
...
..
   ...
   .. image:: ./Creating_Menu/image94.png
...
.. |image1| image:: ./Creating_Menu/image9.png
   :width: 6.29921in
   :height: 2.74692in
.. |image2| image:: ./Creating_Menu/image12.png
   :width: 5.90486in
   :height: 1.59306in
.. |image3| image:: ./Creating_Menu/image21.png
   :width: 4.90694in
   :height: 2.86667in
.. |image4| image:: ./Creating_Menu/image45.png
   :width: 2.75591in
   :height: 1.04062in
.. |image5| image:: ./Creating_Menu/image58.png
   :width: 6.29861in
   :height: 1.79028in
.. |image6| image:: ./Creating_Menu/image62.png
   :width: 3.73958in
   :height: 2.11667in
